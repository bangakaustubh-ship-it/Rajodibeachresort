...
const INITIAL_ROOMS = [
  // ── Executive AC Rooms – 2–3 Persons (001–007) ──────────────────────────
  { id:'001', number:'001', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'002', number:'002', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'003', number:'003', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'004', number:'004', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'005', number:'005', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'006', number:'006', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'007', number:'007', category:'Executive AC Room',       typeKey:'exec-ac',    price:3000, image:'images/executive.png',    status:'booked',  guestDetails:{ guestName:'Amit Sharma', phone:'+91 98112 34567', idType:'Aadhaar Card', idNo:'4532-8910-1123', checkInDate:new Date(Date.now()-86400000).toISOString().slice(0,16), checkOutDate:new Date().toISOString().slice(0,16), advancePaid:1000, notes:'' }, notes:'' },
  // ── Executive AC Twin Rooms – 8 Persons (102, 105) ──────────────────────
  { id:'102', number:'102', category:'Executive AC Twin Room',  typeKey:'exec-twin',  price:5000, image:'images/executive.png',    status:'free',    guestDetails:null, notes:'' },
  { id:'105', number:'105', category:'Executive AC Twin Room',  typeKey:'exec-twin',  price:5000, image:'images/executive.png',    status:'booked',  guestDetails:{ guestName:'Priya Verma', phone:'+91 98765 12345', idType:'Driving License', idNo:'DL-0420210098', checkInDate:new Date().toISOString().slice(0,16), checkOutDate:new Date(Date.now()+86400000).toISOString().slice(0,16), advancePaid:2000, notes:'' }, notes:'' },
  // ── AC Dormitory Rooms – 8–10 Persons (N01–N08) ─────────────────────────
  { id:'N01', number:'N01', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N02', number:'N02', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N03', number:'N03', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N04', number:'N04', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N05', number:'N05', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N06', number:'N06', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  { id:'N07', number:'N07', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'cleaning',guestDetails:null, notes:'Post-group cleaning in progress.' },
  { id:'N08', number:'N08', category:'AC Dormitory Room',       typeKey:'dormitory',  price:8000, image:'images/super_deluxe.png', status:'free',    guestDetails:null, notes:'' },
  // ── Ultima Suite Room – 20 Persons (US01) ───────────────────────────────
  { id:'US01',number:'US01',category:'Ultima Suite Room',       typeKey:'ultima',     price:20000,image:'images/executive_balcony_1.jpg', status:'booked', guestDetails:{ guestName:'Rohan Mehta', phone:'+91 99887 76655', idType:'Passport', idNo:'Z9876543', checkInDate:new Date(Date.now()-43200000).toISOString().slice(0,16), checkOutDate:new Date(Date.now()+43200000).toISOString().slice(0,16), advancePaid:5000, notes:'VIP Group. Complimentary welcome setup arranged.' }, notes:'VIP Suite' },
];
...
function getImagePath(typeKey) {
  if (typeKey === 'exec-ac')    return 'images/executive.png';
  if (typeKey === 'exec-twin')  return 'images/executive.png';
  if (typeKey === 'dormitory')  return 'images/super_deluxe.png';
  if (typeKey === 'ultima')     return 'images/executive_balcony_1.jpg';
  return 'images/executive.png';
}
...
function updateCharts() {
  ...
  const execAcRev   = rooms.filter(r => r.status === 'booked' && r.typeKey === 'exec-ac').reduce((s, r)   => s + r.price * 1.18, 0);
  const execTwinRev = rooms.filter(r => r.status === 'booked' && r.typeKey === 'exec-twin').reduce((s, r) => s + r.price * 1.18, 0);
  const dormRev     = rooms.filter(r => r.status === 'booked' && r.typeKey === 'dormitory').reduce((s, r) => s + r.price * 1.18, 0);
  const ultimaRev   = rooms.filter(r => r.status === 'booked' && r.typeKey === 'ultima').reduce((s, r)    => s + r.price * 1.18, 0);

  revenueChartInst.data.datasets[0].data = [execAcRev, execTwinRev, dormRev, ultimaRev];
...
function buildRoomCard(room, idx) {
  ...
  let extras = [];
  // Add capacity info for different room types
  if (room.typeKey === 'exec-ac')  extras.push(`<div style="font-size:0.76rem;color:#34d399;margin-top:0.2rem;"> <i class="fa-solid fa-user-group"></i> 2–3 Pax Capacity</div>`);
  if (room.typeKey === 'exec-twin')  extras.push(`<div style="font-size:0.76rem;color:#34d399;margin-top:0.2rem;"><i class="fa-solid fa-user-group"></i> 8 Pax Capacity</div>`);
  if (room.typeKey === 'dormitory')  extras.push(`<div style="font-size:0.76rem;color:#60a5fa;margin-top:0.2rem;"><i class="fa-solid fa-people-roof"></i> 8–10 Pax Capacity</div>`);
  if (room.typeKey === 'ultima')     extras.push(`<div style="font-size:0.76rem;color:#fbbf24;margin-top:0.2rem;"><i class="fa-solid fa-crown"></i> Ultima Suite – Up to 20 Pax</div>`);
